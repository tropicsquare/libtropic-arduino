...
- [ ] I followed the project's [**code guidelines**](https://github.com/tropicsquare/libtropic-arduino/blob/develop/CONTRIBUTING.md)  
- [ ] I formatted the code using **clang-format** with the [recommended configuration](https://github.com/tropicsquare/libtropic-arduino/blob/develop/CONTRIBUTING.md#code-formatter)
- [ ] I updated the [**changelog**](https://github.com/tropicsquare/libtropic-arduino/blob/develop/CHANGELOG.md), or this change does not require it (e.g., internal or non-functional update)  
- [ ] The project **builds without errors or warnings**  
- [ ] I have **verified the functionality against the hardware** as applicable
