...
class Tropic01 {
   public:
     ...
     * @param print_func[in]  Pointer to a printf-style function used to output the formatted text (e.g. printf)
     *
     * @retval                LT_OK Method executed successfully
     * @retval                other Method did not execute successfully, you might use lt_ret_verbose() to get verbose
     * encoding of returned value
     ...
     * @details The chip is temporarily rebooted into maintenance mode to read the bootloader version and then
     *          rebooted back to its original mode.
     *
    ...
    /**
     * @brief Prints the firmware headers (FW1, FW2, SPECT1, SPECT2) stored in TROPIC01 using the provided print
     * function.
     * @details The chip is temporarily rebooted into maintenance mode to read the firmware headers and then
     *          rebooted back to its original mode.
     *
     * @param print_func[in]  Pointer to a printf-style function used to output the formatted text (e.g. printf)
     *
     ...
     * @param rand_len[in]   Number of random bytes to generate (max TR01_RANDOM_VALUE_GET_LEN_MAX, i.e. 255)
     *
     * @retval               LT_OK Method executed successfully
     * @retval               other Method did not execute successfully, you might use lt_ret_verbose() to get verbose
     * encoding of returned value
     ...
     *
     * @param index[in]   Monotonic counter index (TR01_MCOUNTER_INDEX_0 - TR01_MCOUNTER_INDEX_15)
     * @param value[out]  Current value of the monotonic counter (from range 0 - TR01_MCOUNTER_VALUE_MAX)
     *
     * @retval            LT_OK Method executed successfully
     * @retval            other Method did not execute successfully, you might use lt_ret_verbose() to get verbose
     * encoding of returned value
